...
///     let locationManagerSubject = PassthroughSubject<LocationManager.Action>()
///
///     let store = TestStore(
///       initialState: AppState(),
///       reducer: appReducer,
...
public struct LocationManager {
  ...
  var create: (AnyHashable) -> Effect<Action> = { _ in _unimplemented("create") }

  var destroy: (AnyHashable) -> Effect<Never> = { _ in _unimplemented("destroy") }

  @available(macOS, unavailable)
  @available(tvOS, unavailable)
  var dismissHeadingCalibrationDisplay: (AnyHashable) -> Effect<Never> = { _ in
  ...
  @available(tvOS, unavailable)
  var requestAlwaysAuthorization: (AnyHashable) -> Effect<Never> = { _ in
    _unimplemented("requestAlwaysAuthorization")
  }

  var requestLocation: (AnyHashable) -> Effect<Never> = { _ in
    _unimplemented("requestLocation")
  }

  @available(macOS, unavailable)
  var requestWhenInUseAuthorization: (AnyHashable) -> Effect<Never> = { _ in
    _unimplemented("requestWhenInUseAuthorization")
  }

  var set: (AnyHashable, Properties) -> Effect<Never> = { _, _ in _unimplemented("set") }
  ...
  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  var startMonitoringForRegion: (AnyHashable, Region) -> Effect<Never> = { _, _ in
    _unimplemented("startMonitoringForRegion")
  }

  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  var startMonitoringSignificantLocationChanges: (AnyHashable) -> Effect<Never> = { _ in
  ...
  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  var startMonitoringVisits: (AnyHashable) -> Effect<Never> = { _ in
    _unimplemented("startMonitoringVisits")
  }

  @available(macOS, unavailable)
  @available(tvOS, unavailable)
  var startUpdatingHeading: (AnyHashable) -> Effect<Never> = { _ in
    _unimplemented("startUpdatingHeading")
  }

  @available(tvOS, unavailable)
  var startUpdatingLocation: (AnyHashable) -> Effect<Never> = { _ in
    _unimplemented("startUpdatingLocation")
  }

  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  var stopMonitoringForRegion: (AnyHashable, Region) -> Effect<Never> = { _, _ in
    _unimplemented("stopMonitoringForRegion")
  }

  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  var stopMonitoringSignificantLocationChanges: (AnyHashable) -> Effect<Never> = { _ in
  ...
  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  var stopMonitoringVisits: (AnyHashable) -> Effect<Never> = { _ in
    _unimplemented("stopMonitoringVisits")
  }

  @available(macOS, unavailable)
  @available(tvOS, unavailable)
  var stopUpdatingHeading: (AnyHashable) -> Effect<Never> = { _ in
    _unimplemented("stopUpdatingHeading")
  }

  var stopUpdatingLocation: (AnyHashable) -> Effect<Never> = { _ in
  ...
  @available(macOS, unavailable)
  @available(tvOS, unavailable)
  public func dismissHeadingCalibrationDisplay(id: AnyHashable) -> Effect<Never> {
  ...
  @available(tvOS, unavailable)
  public func requestAlwaysAuthorization(id: AnyHashable) -> Effect<Never> {
    self.requestAlwaysAuthorization(id)
  }

  public func requestLocation(id: AnyHashable) -> Effect<Never> { self.requestLocation(id) }

  @available(macOS, unavailable)
  public func requestWhenInUseAuthorization(id: AnyHashable) -> Effect<Never> {
  ...
  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  public func startMonitoringForRegion(id: AnyHashable, region: Region) -> Effect<Never> {
    self.startMonitoringForRegion(id, region)
  }

  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  public func startMonitoringSignificantLocationChanges(id: AnyHashable) -> Effect<Never> {
  ...
  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  public func startMonitoringVisits(id: AnyHashable) -> Effect<Never> {
    self.startMonitoringVisits(id)
  }

  @available(macOS, unavailable)
  @available(tvOS, unavailable)
  public func startUpdatingHeading(id: AnyHashable) -> Effect<Never> {
    self.startUpdatingHeading(id)
  }

  @available(tvOS, unavailable)
  public func startUpdatingLocation(id: AnyHashable) -> Effect<Never> {
    self.startUpdatingLocation(id)
  }

  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  public func stopMonitoringForRegion(id: AnyHashable, region: Region) -> Effect<Never> {
    self.stopMonitoringForRegion(id, region)
  }

  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  public func stopMonitoringSignificantLocationChanges(id: AnyHashable) -> Effect<Never> {
  ...
  @available(tvOS, unavailable)
  @available(watchOS, unavailable)
  public func stopMonitoringVisits(id: AnyHashable) -> Effect<Never> {
    self.stopMonitoringVisits(id)
  }

  @available(macOS, unavailable)
  @available(tvOS, unavailable)
  public func stopUpdatingHeading(id: AnyHashable) -> Effect<Never> {
    self.stopUpdatingHeading(id)
  }

  public func stopUpdatingLocation(id: AnyHashable) -> Effect<Never> {
